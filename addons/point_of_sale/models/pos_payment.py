...
class PosPayment(models.Model):
    ...
    def _load_pos_data_fields(self, config):
        return [
            ...
            'payment_date', 'currency_id', 'currency_rate', 'partner_id',
            'session_id', 'user_id', 'company_id', 'card_type', 'card_brand',
            'card_no', 'cardholder_name', 'payment_ref_no', 'payment_method_authcode',
            'payment_method_issuer_bank', 'payment_method_payment_mode',
            'transaction_id', 'payment_status', 'ticket', 'is_change',
