...
class PosOrder(models.Model):
    ...
    def _load_pos_data_fields(self, config):
        return [
            'id', 'name', 'date_order', 'user_id', 'lines', 'payment_ids',
            'partner_id', 'session_id', 'config_id', 'amount_total', 'amount_tax',
            'amount_paid', 'amount_return', 'pos_reference', 'fiscal_position_id',
            'pricelist_id', 'state', 'is_refund', 'company_id', 'tracking_number',
            'sequence_number', 'ticket_code', 'nb_print',
            'picking_type_id', 'floating_order_name', 'general_customer_note',
            'internal_note', 'shipping_date', 'last_order_preparation_change',
            'uuid', 'email', 'mobile', 'is_edited', 'has_deleted_line'
        ]
