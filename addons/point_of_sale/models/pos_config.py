...
class PosConfig(models.Model):
    ...
    def _load_pos_data_fields(self, config):
        return [
            'id', 'name', 'journal_id', 'invoice_journal_id', 'currency_id', 'payment_method_ids',
            'pricelist_id', 'available_pricelist_ids', 'use_pricelist',
            'picking_type_id', 'company_id', 'iface_tax_included',
            'iface_big_scrollbars', 'iface_print_auto',
            'iface_print_skip_screen', 'iface_print_via_proxy', 'iface_scan_via_proxy',
            'iface_electronic_scale', 'iface_cashdrawer', 'iface_available_categ_ids',
            'is_posbox', 'is_header_or_footer', 'rounding_method',
            'only_round_cash_method', 'cash_rounding', 'use_fast_payment',
            'fast_payment_method_ids', 'order_edit_tracking', 'use_presets',
            'default_preset_id', 'trusted_config_ids', 'show_product_images', 'show_category_images'
        ]
